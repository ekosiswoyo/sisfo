...
?>
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Data Nilai Kesehatan</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><a href="input_kesehatan.php?id=<?php echo $sqlcari['nis']; ?>&kelas=<?php echo $sqlcari['kd_kelas']; ?>"><button type="button" class="btn btn-outline btn-primary btn-xs">Lihat Nilai</button></a></td>
                                                    <td>
                                                    <input class="form-control" placeholder="Kegiatan" name="nis[]" value="<?php echo $sqlcari['nis'];?>" type="hidden">
                                                    <input class="form-control" placeholder="Aspek" name="aspek[]" required>
                                                    </td>
                                                    <td>
...
if(isset($_POST['simpan'])){
    ...
    for($i=0;$i<=$jumlah;++$i){
        $sql = "INSERT INTO tb_kesehatan (nis,aspek,keterangan) VALUES ('$nis[$i]','$aspek[$i]','$keterangan[$i]')";
    ...
    if($query){
       ...
       echo "<script>window.location='kesehatan.php?ids';</script>";
    }else{
