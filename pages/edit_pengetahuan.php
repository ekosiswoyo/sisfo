...
if(isset($_POST['simpan'])){
    ...
    // for($i=0;$i<=$jumlah;++$i){
        $sql = "UPDATE tbl_nilai_pengetahuan set tema1='$tema1', tema2='$tema2', tema3='$tema3', tema4='$tema4', tema5='$tema5', deskripsi='$deskripsi' where kd_nilai_pengetahuan='$kd_nilai_pengetahuan'";
