...
if(isset($_POST['simpan'])){
    ...
    for($i=0;$i<=$jumlah;++$i){
        $sql = "INSERT INTO tbl_nilai_pengetahuan (kd_mapel,nis,tema1,tema2,tema3,tema4,tema5,deskripsi) VALUES ('$kd_mapel[$i]','$nis[$i]','$tema1[$i]','$tema2[$i]','$tema3[$i]','$tema4[$i]','$tema5[$i]','$deskripsi[$i]')";
    ...
    if($query){
       ...
       echo "<script>window.location='pengetahuan_walikelas.php?ids';</script>";
    }else{
