                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><a href="input_kehadiran.php?id=<?php echo $sqlcari['nis']; ?>&kelas=<?php echo $sqlcari['kd_kelas']; ?>"><button type="button" class="btn btn-outline btn-primary btn-xs">Lihat Kehadiran</button></a></td>
                                                    <td>
                                                    <input class="form-control" name="nis[]" value="<?php echo $sqlcari['nis'];?>" type="hidden">
                                                    <input class="form-control" placeholder="Sakit" name="sakit[]" required>
                                                    </td>
                                                    <td>
                                                    <input class="form-control" placeholder="Ijin" name="ijin[]" required>
                                                    </td>


                                                    <td><input class="form-control" placeholder="Alpha" name="alpha[]" required></td>
                                                </tr>
                                                <?php 
                                                    }
                                             ?>
...
if(isset($_POST['simpan'])){
    ...
    for($i=0;$i<=$jumlah;++$i){
        $sql = "INSERT INTO tb_kehadiran (nis,sakit,ijin,alpha) VALUES ('$nis[$i]','$sakit[$i]','$ijin[$i]','$alpha[$i]')";
