...
include 'header.php';
$id = $_GET['id'];
$sql = mysqli_query($connect,"select * from tb_kelas where kd_kelas='$id'");
...
?>
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Form Edit Data Kelas</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                                        ...
                                        <div class="col-lg-12">
                                            <form method="POST" action="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Kode Kelas" name="kd_kelas" value="<?php echo $cari['kd_kelas']; ?>" readonly>
                                                </div>

                                                <div class="form-group">
                                                    <label>Nama Kelas</label>
                                                    <input class="form-control" placeholder="Nama Kelas" name="nm_kelas" value="<?php echo $cari['nm_kelas']; ?>">
                                                </div>
...
if(isset($_POST['simpan'])){
    ...
    $sql = "UPDATE tb_kelas set nm_kelas = '$nm_kelas', nip = '$wali_kelas' where kd_kelas = '$kd_kelas'";
