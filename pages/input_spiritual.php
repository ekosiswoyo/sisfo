...
?>
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Data Nilai Sikap Spiritual Siswa</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                $no = 1;
                                                    ...
                                                    <td><a href="editnilaispiritual.php?id=<?php echo $datas['kd_nilai_sikap'];?>&nis=<?php echo $datas['nis']; ?>&kelas=<?php echo $datas['kd_kelas']; ?>"><i class="fa fa-edit" aria-hidden="true" title="Edit"></i></a>&nbsp;<a href="delnilaispiritual.php?id=<?php echo $datas['kd_nilai_sikap'];?>&nis=<?php echo $datas['nis']; ?>&kelas=<?php echo $datas['kd_kelas']; ?>"  onclick="javascript: return confirm('Anda yakin hapus ?')"><i class="fa fa-trash-o" aria-hidden="true" title="Delete"></i></a></td>
