...
?>
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Input Nilai Sikap Sosial Siswa</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><a href="input_sosial.php?id=<?php echo $sqlcari['nis']; ?>&kelas=<?php echo $sqlcari['kd_kelas']; ?>"><button type="button" class="btn btn-outline btn-primary btn-xs">Lihat Nilai</button></a></td>
                                                    <td>
...
if(isset($_POST['simpan'])){
    ...
    for($i=0;$i<=$jumlah;++$i){
        $sql = "INSERT INTO tb_nilai_sikap (nis,positif,negatif,status,keterangan) VALUES ('$nis[$i]','$positif[$i]','$negatif[$i]','sosial','$keterangan[$i]')";
    ...
    if($query){
       ...
       echo "<script>window.location='sosial.php?ids=$kd_kelas';</script>";
    }else{
