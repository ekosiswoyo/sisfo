                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><a href="input_saran.php?id=<?php echo $sqlcari['nis']; ?>&kelas=<?php echo $sqlcari['kd_kelas']; ?>"><button type="button" class="btn btn-outline btn-primary btn-xs">Lihat Saran</button></a></td>
                                                    <td>
                                                    <input class="form-control" name="nis[]" value="<?php echo $sqlcari['nis'];?>" type="hidden">
                                                    <textarea class="form-control" placeholder="Saran" name="saran[]" required></textarea>
                                                    </td>
...
if(isset($_POST['simpan'])){
    ...
    for($i=0;$i<=$jumlah;++$i){
        $sql = "INSERT INTO tb_saran (nis,saran) VALUES ('$nis[$i]','$saran[$i]')";
