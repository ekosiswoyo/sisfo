                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                $no = 1;
                                                    ...
                                                    <td><a href="editnilaiprestasi.php?id=<?php echo $datas['kd_nilai_prestasi'];?>&nis=<?php echo $datas['nis']; ?>&kelas=<?php echo $datas['kd_kelas']; ?>"><i class="fa fa-edit" aria-hidden="true" title="Edit"></i></a>&nbsp;<a href="delnilaiprestasi.php?id=<?php echo $datas['kd_nilai_prestasi'];?>&nis=<?php echo $datas['nis']; ?>&kelas=<?php echo $datas['kd_kelas']; ?>"  onclick="javascript: return confirm('Anda yakin hapus ?')"><i class="fa fa-trash-o" aria-hidden="true" title="Delete"></i></a></td>
