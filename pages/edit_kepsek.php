...
$sqluser = mysqli_query($connect,"select * from tb_user where level = 'Kepala Sekolah'");
$cariuser = mysqli_fetch_array($sqluser);
$pass = md5($cariuser['password']);
?>
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Form Detail Data Kepala Sekolah</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
...
if(isset($_POST['simpan'])){
    ...
    $sql = "UPDATE tb_guru SET nm_guru='$nm_guru', jns_kel='$jns_kel', alamat='$alamat', pend_terakhir='$pend_terakhir',  status='$status' where jabatan='Kepala Sekolah'";
