...
?>
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Detail Nilai Ketrampilan Siswa</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                       ...
                                       <?php
                                        $siswa = mysqli_query($connect, "SELECT * FROM tbl_nilai_keterampilan a, tb_siswa b, tb_mapel c where a.nis='$nis' and b.nis=a.nis and a.kd_mapel='$mapel' and a.kd_mapel=c.kd_mapel");
                                    ...
                                    <form method="POST" action="">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                $no = 1;
                                                        $data = mysqli_query($connect, "SELECT * FROM tbl_nilai_keterampilan a, tb_siswa b, tb_mapel c where a.nis='$nis' and b.nis=a.nis and a.kd_mapel='$mapel' and a.kd_mapel=c.kd_mapel");
                                                    ...
                                                    $data = mysqli_query($connect, "SELECT a.kd_mapel,a.tema1,a.tema2,a.tema3,a.tema4,a.tema5,sum(a.tema1) as jml_tema1, sum(a.tema2) as jml_tema2, sum(a.tema3) as jml_tema3, sum(a.tema4) as jml_tema4, sum(a.tema5) as jml_tema5 FROM tbl_nilai_keterampilan a, tb_siswa b, tb_mapel c where a.nis='$nis' and b.nis=a.nis and a.kd_mapel='$mapel' and a.kd_mapel=c.kd_mapel");
                                                            while($datas = mysqli_fetch_array($data)){
