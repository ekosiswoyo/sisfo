...
?>
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Input Nilai Sikap Spiritual Siswa</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><a href="input_spiritual.php?id=<?php echo $sqlcari['nis']; ?>&kelas=<?php echo $sqlcari['kd_kelas']; ?>"><button type="button" class="btn btn-outline btn-primary btn-xs">Lihat Nilai</button></a></td>
                                                    <td>
                                                    ...
                                                    <input class="form-control" placeholder="Positif" name="positif[]" required>
                                                    </td>
                                                    <td>
                                                    <input class="form-control" placeholder="Negatif" name="negatif[]" required>
                                                    </td>
                                                    <td>
...
if(isset($_POST['simpan'])){
    ...
    $jumlah = count($keterangan) - 1;

    for($i=0;$i<=$jumlah;++$i){
        $sql = "INSERT INTO tb_nilai_sikap (nis,positif,negatif,status,keterangan) VALUES ('$nis[$i]','$positif[$i]','$negatif[$i]','Spiritual','$keterangan[$i]')";
    ...
    if($query){
       ...
       echo "<script>window.location='spiritual.php?ids=$kd_kelas';</script>";
    }else{
